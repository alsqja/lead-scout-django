...
class PDFAnalysisService:
    ...
    def analyze_company_pdf(self, pdf_path, company_name):
        """
        PDF 파일을 분석하여 회사 정보를 추출합니다.
        ...
        try:
            ...
            company_info = self._extract_company_info_with_ai(extracted_text, company_name)
            return company_info
